...
V3 adds repaired wall helpers, double-sided lit materials, six fan loops, automatic entrance doors and installed-fixture lighting. The staff desk groups and PROP__slumped_carrot now belong to the garage collection. Keep the carrot collider with the character if relocating it. The shop, street and backroom files end in _v3.glb; the garage is _v4.glb with its porch lamp; the old root backroom.glb is intentionally preserved for the reference space.